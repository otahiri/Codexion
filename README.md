...
Scheduling/fairness is configurable via `fifo` (first-come-first-served) or `edf` (earliest deadline first-style, based on the last compile time).
...
- Used AI for: debugging deadlocks and writing the readme file
